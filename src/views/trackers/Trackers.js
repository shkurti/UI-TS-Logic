...
const Trackers = () => {
  ...
  return (
    <>
      ...
      {/* Example: Add this inside your tracker details/modal or table row if you want sensor icons */}
      <div className="sensor-icons d-flex justify-content-center mb-2" style={{ gap: 16 }}>
        <div
          style={{
            display: 'flex',
