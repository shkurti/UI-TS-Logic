        ...
        <>
          ...
          <div style={{ 
            ...
            >
              ...
              {console.log('Rendering map with:', { startCoord, destinationCoord, liveRoute: liveRoute?.length, selectedShipment: !!selectedShipment })}
              
              {/* START MARKER (1) - ALWAYS show from shipment address when shipment selected */}
              {selectedShipment && startCoord && Array.isArray(startCoord) && startCoord.length === 2 && (
                <Marker 
                  position={startCoord} 
                  icon={numberIcon('1')}
              ...
              {/* DESTINATION MARKER (2) - ALWAYS show from shipment address when shipment selected */}
              {selectedShipment && destinationCoord && Array.isArray(destinationCoord) && destinationCoord.length === 2 && (
                <Marker 
